...
SELECT fn_disponibilidade_veterinario(1, '2024-05-02 09:30', 60);
-- listar horários livres por veterinário
SELECT f.nome AS veterinario, fn_disponibilidade_veterinario(v.funcionario_id, '2024-05-02 09:00', 60) AS livre_09h, fn_disponibilidade_veterinario(v.funcionario_id, '2024-05-02 10:00', 60) AS livre_10h, fn_disponibilidade_veterinario(v.funcionario_id, '2024-05-02 11:00', 60) AS livre_11h
FROM veterinario v
...
-- verificar fatura:
SELECT * FROM fatura WHERE id = (SELECT fn_gerar_fatura(4, 3));
