...
VALUES (1, 1, 4, 1, '2024-03-05 09:00');
...
VALUES (5, 1, 6, 'LOTE-2027', '2027-01-01', CURRENT_DATE, 'anual', CURRENT_DATE + INTERVAL '1 year');
...
SELECT valor_total, valor_plano, valor_cliente FROM fatura WHERE id = 1;
